...
import { Calendar, Clock, Users, Filter, Search, Plus, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
...
const Attendance = () => {
  ...
  const departments = ['all', ...Array.from(new Set(attendanceData.map(r => r.department).filter(Boolean)))];
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="container mx-auto bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="flex items-center gap-4 mb-8 border-b pb-6 border-gray-200">
          ...
          <h1 className="text-4xl font-extrabold text-gray-800">Attendance Management</h1>
        </div>
