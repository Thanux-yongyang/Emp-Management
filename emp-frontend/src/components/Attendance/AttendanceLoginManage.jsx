...
const {addAttendanceLogin} = useAttendanceLoginContext();
  ...
  const AutoGenerateID = (e) =>{
    if(!form.firstName || !form.employeeId) {
      alert("Please select an employee first to generate credentials.");
      return;
    }
    const romajiFirstName = wanakana.toRomaji(form.firstName || "");
    const username = `${romajiFirstName}${form.employeeId}`;
    const password = username; // Use the same username as password for simplicity
...
setForm((prev) => ({
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await addAttendanceLogin(userData);
        ...
        <div className="text-center  flex items-center justify-center space-x-4 mb-4">
          ...
          <div className="text-left pt-8">
            ...
            <p className="text-gray-600 ">
              Credentials for employee attendance login
            </p>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-3 space-y-4 ">
            ...
            <button
                    ...
                    className="px-5 py-4 flex-1 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center"
                  >
