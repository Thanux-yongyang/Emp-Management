...
const AttendanceDetail = () => {
  ...
  const handleSave = () => {
    ...
    const updatedData = attendanceData.map((record) =>
      record.id === editingRecord.id ? { ...record, ...editForm } : record
    );
    setAttendanceData(updatedData);
    setEditingRecord(null);
    setEditForm({ checkIn: "", checkOut: "", break: 1 });
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <p>
                  <span className="font-medium">Phone:</span> {employee.phoneNo}
                </p>
              </div>
            </div>
            <div>
                      ...
                      {editingRecord?.day === row.day ? (
                        <input
                          ...
                          onChange={(e) =>
                            setEditForm({
                              ...editForm,
                              break: parseFloat(e.target.value),
                            })
                          }
